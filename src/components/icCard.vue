      ...
      <div class="main-list">
        ...
        <div class="cardInfo">
          ...
          <div class="cardInfo__detail">
            ...
            <div class="cardInfo__detail_item" v-for="item in info.membership_card" :key="item.id">会员卡：{{item.card_type.CTName}}</div>
          </div>
        </div>
      </div>
      <div class="main-list">
        ...
        <div class="main-table">
          <el-table :data="course" highlight-current-row style="width: 100%"
    ...
    methods: {
      clickEnter(index) {
        ...
        let params = {
          ...
          number: this.handCardNumber ? this.handCardNumber : '0000',
          bool: curCourse.curriculum_table.kcIsPrivate == "团课课程" ? true : false
        };

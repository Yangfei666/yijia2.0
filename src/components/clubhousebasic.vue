                        ...
                        <el-dialog title="修改会所基本信息" :append-to-body="true" :visible.sync="dialogFormVisible">
                            ...
                            <el-form :model="ruleForm" label-width="100px">
                                ...
                                <el-form-item label="预售开始时间:" prop="starttime" :label-width="formLabelWidth">
                                    <el-col :span="22">
                                        <el-date-picker v-model="ruleForm.startTime" format="yyyy-MM-dd" value-format="yyyy-MM-dd" type="date" style="width:100%"></el-date-picker>
                                    </el-col>
                                </el-form-item>
                                <el-form-item label="预售结束时间:" prop="preSaleTime" :label-width="formLabelWidth">
                                    <el-col :span="22">
                                        <el-date-picker v-model="ruleForm.preSaleTime" format="yyyy-MM-dd" value-format="yyyy-MM-dd" type="date" style="width:100%"></el-date-picker>
                                    </el-col>
                                </el-form-item>

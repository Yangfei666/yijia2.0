    ...
    <div>
        <el-form :model="currentSelectRow" ref="currentSelectRow" label-width="100px">
            <el-form-item label="分类:" prop="classify" :label-width="formLabelWidth">
                <el-col :span="22">
                    <el-select v-model="currentSelectRow.banState" :placeholder="currentSelectRow.banState" style="width:100%" @change="Selectchange2">
        ...
        if (valid) {
          this.$confirm("确认提交吗？", "提示").then(() => {
            ...
            var loginParams = {
              ...
              banState: this.currentSelectRow.banState, //分类

...
const cityOptions2 = ['会员资料录入', '开卡审核', '会员续会/充值', '会员积分','更换会籍顾问',
'更换教练','会员请假/销假','会员综合信息查询编辑','意向会员交定金','意向会员定金管理','补开卡',
'放弃定金','上课记录'];//会员管理
...
export default {
    ...
    methods: {
      ...
      handleCheckedCitiesChange11(value) {
        ...
        this.isIndeterminate11 = checkedCount11 > 0 && checkedCount11 < this.membercardunder.length;
      },
      handleCheckedCitiesChange12(value) {
        let checkedCount12 = value.length;
        this.checkAll12 = checkedCount12 === this.datereport.length;
        this.isIndeterminate12 = checkedCount12 > 0 && checkedCount12 < this.datereport.length;
      },
    }
}
</script>

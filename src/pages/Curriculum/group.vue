      ...
      <div class="group-main">
        <div class="group-head">
          <div class="group-right">
            <el-date-picker v-model="mondayDate" type="daterange" range-separator="至" :disabled="true" style="width:230px;margin-top:4px" :start-placeholder="Monday" :end-placeholder="Sunday"></el-date-picker>
            <el-date-picker v-model="dateValue" @change="changeWeek" :clearable="false" type="week" format="yyyy 第 WW 周" placeholder="选择周" :firstDayOfWeek="1" style="margin-top:-1px;width:153px"></el-date-picker>
          ...
          <el-tabs v-model="activeName" @tab-click="handleClick" type="card">
            <el-tab-pane label="周一" name="monday">
              <Grouptimetable :floorGoods='tdlist' :classrooms="classroom" :coachs="coach" :subjects="subject" :clubIndex="selectClubIndex" :clubs="club" :weekDay='1'></Grouptimetable>
            </el-tab-pane>
            <el-tab-pane label="周二" name="tuesday">
              <Grouptimetable :floorGoods='tdlist' :classrooms="classroom" :coachs="coach" :subjects="subject" :clubIndex="selectClubIndex" :clubs="club" :weekDay='2'></Grouptimetable>
            </el-tab-pane>
            <el-tab-pane label="周三" name="wednesday">
              <Grouptimetable :floorGoods='tdlist' :classrooms="classroom" :coachs="coach" :subjects="subject" :clubIndex="selectClubIndex" :clubs="club" :weekDay='3'></Grouptimetable>
            </el-tab-pane>
            <el-tab-pane label="周四" name="thursday">
              <Grouptimetable :floorGoods='tdlist' :classrooms="classroom" :coachs="coach" :subjects="subject" :clubIndex="selectClubIndex" :clubs="club" :weekDay='4'></Grouptimetable>
            </el-tab-pane>
            <el-tab-pane label="周五" name="friday">
              <Grouptimetable :floorGoods='tdlist' :classrooms="classroom" :coachs="coach" :subjects="subject" :clubIndex="selectClubIndex" :clubs="club" :weekDay='5'></Grouptimetable>
            </el-tab-pane>
            <el-tab-pane label="周六" name="saturday">
              <Grouptimetable :floorGoods='tdlist' :classrooms="classroom" :coachs="coach" :subjects="subject" :clubIndex="selectClubIndex" :clubs="club" :weekDay='6'></Grouptimetable>
            </el-tab-pane>
            <el-tab-pane label="周日" name="weekday">
              <Grouptimetable :floorGoods='tdlist' :classrooms="classroom" :coachs="coach" :subjects="subject" :clubIndex="selectClubIndex" :clubs="club" :weekDay='7'></Grouptimetable>
            </el-tab-pane>
          </el-tabs>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    Monday() {
      if (this.dateValue == "") {
        this.mondayDate = this.GetDateStr(
          0,
      ...
      requestLogin("/allClub", {}, "get")
        ...
        .then(() => {
          _this.selectClubIndex = _this.club.findIndex(
            item => item.Hsxx_Hsid === _this.selectClubID
          );
